...
session_start();
$date = date('Y-m-d');
$q = mysqli_query($conn, "SELECT * FROM absen JOIN (SELECT fingerprint.fingerprint,struktur.* FROM fingerprint JOIN struktur ON fingerprint.nip = struktur.nip WHERE fingerprint.nip=$_SESSION[NIP]) AS people ON absen.fingerprint = people.fingerprint");
?>
<div class="row">
    <div class="col-sm-12">
        <div class="card">
